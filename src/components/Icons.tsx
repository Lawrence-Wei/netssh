...
export type IconName =
  ...
  | "palette" | "globe" | "shell" | "key" | "terminal" | "keyboard" | "settings" | "bookmark" | "user"
...
export const Icon: Record<IconName, ReactNode> = {
  ...
  user: <svg viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5.4" r="2.6" stroke="currentColor" strokeWidth="1.25" /><path d="M3.2 13.2C3.7 10.8 5.6 9.3 8 9.3C10.4 9.3 12.3 10.8 12.8 13.2" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" /></svg>,
