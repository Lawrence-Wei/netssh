...
export const Icon: Record<IconName, ReactNode> = {
  ...
  settings: <svg viewBox="0 0 14 14" fill="none"><circle cx="7" cy="7" r="1.5" stroke="currentColor" strokeWidth="1.2" /><path d="M7 1V3M7 11V13M1 7H3M11 7H13M2.8 2.8L4.2 4.2M9.8 9.8L11.2 11.2M2.8 11.2L4.2 9.8M9.8 4.2L11.2 2.8" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" /></svg>,
